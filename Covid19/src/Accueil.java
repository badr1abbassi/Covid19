...
public class Accueil {
	...
	private String tableauRegions[] = { "F�s-Mekn�s", "Oriental", "Guelmim-Oued Noun", "Souss-Massa", "Dr�a-Tafilalet",
			"Marrakech-Safi", "Casablanca-Settat", "B�ni Mellal-Kh�nifra", "Tanger-T�touan-Al Hoce�ma",
			"Rabat-Sal�-K�nitra", "Dakhla-Oued Ed Dahab", "La�youne-Sakia El Hamra" };
	public Accueil() {
		try {
